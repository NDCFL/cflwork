        ...
        <div class="ibox-content">
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group" style="margin-bottom:0px;">
								...
								<div class="col-sm-2">
									<input  id="incomeId__" name="incomeId"  type="text" class="form-control" required="" aria-required="true">
								</div>
							</div>
																								<div class="panel-body form-group" style="margin-bottom:0px;">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="formadd">
                <div class="modal-body">
								...
								<div class="col-sm-8">
									<input  id="incomeId" name="incomeId"  type="text" class="form-control" required="" aria-required="true">
								</div>
							</div>
																								<div class="form-group">
